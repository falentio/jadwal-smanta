...
<section
	class="flex flex-col flex-wrap justify-center w-full md:w-2/3 mx-auto bg-sky-300 ring-1 ring-black"
>
	<div
		class="text-xl md:text-2xl font-bold text-center flex-row flex justify-between items-center my-2"
	>
